...
//        SwitchCompat switch_allDay = (SwitchCompat) findViewById(R.id.switch_allDay);
//        AppCompatTextView textView_startDate = (AppCompatTextView) findViewById(R.id.textView_startDate);
//        AppCompatTextView textView_endDate = (AppCompatTextView) findViewById(R.id.textView_endDate);
//        AppCompatTextView textView_startTime  = (AppCompatTextView) findViewById(R.id.textView_startTime);
//        AppCompatTextView textView_endTime = (AppCompatTextView) findViewById(R.id.textView_endTime);
        ...
        String startDate_value = textView_startDate.getText().toString();//java 语法中有一个是能够把“用逗号分开的字符串”一个一个切开，这里暂且搁置，等成功插入数据库后，看下数据库中存储的样式是什么
        ...
        String alert_value = textView_alert.getText().toString();//下面传入的时候 Integer.parseInt()会报错，于是改掉了？？
