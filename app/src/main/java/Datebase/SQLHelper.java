...
public class SQLHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db){
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS time_table(" +
                ...
                "date_start STRING,"+
                "date_end STRING,"+
                "time_year_start integer,"+
                "time_month_start integer,"+
                "time_day_start integer,"+
                "time_hour_start integer,"+
                "time_minute_start integer,"+
                "time_year_end integer,"+
                "time_month_end integer,"+
                "time_day_end integer,"+
                "time_hour_end integer,"+
                "time_minute_end integer"+
                ");");
